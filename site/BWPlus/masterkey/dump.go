...
// Dump is the portable, cross-host container for Chromium master keys 鈥?produce it on one host to
...
// ReadJSON parses a Dump and rejects any version this build can't interpret 鈥?a silent misparse of an
