...
// Latin-1 byte values map 1:1 to Unicode code points U+0000鈥揢+00FF.
...
// LevelDB key format:
//
//	namespace-<guid>-<origin> 鈫?<map_id>   (origin mapping)
//	map-<map_id>-<key_name>  鈫?<value>     (actual data, UTF-16 LE)
...
func extractSessionStorage(path string) ([]types.StorageEntry, error) {
	...
	// Pass 1: build map_id 鈫?origin lookup from namespace entries.
