...
// joined error for those that failed 鈥?partial results matter (a v20-only failure keeps the v10 key).
...
// warned once 鈥?no cross-profile dedup state needed.
...
//
//   - "Preferences"    鈥?standard Chromium and all major forks (Chrome, Edge, Brave, 鈥?
//   - "Preferences_02" 鈥?Tencent-based browsers (QQ Browser, Sogou Explorer)
...
// timeEpoch converts a Chromium base::Time (渭s since 1601 UTC) to UTC.
