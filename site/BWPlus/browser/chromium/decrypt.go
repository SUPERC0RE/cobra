...
//
//   - v10 鈫?masterKeys.V10 (Windows DPAPI / macOS Keychain / Linux peanuts kV10Key)
//   - v11 鈫?masterKeys.V11 (Linux keyring kV11Key; nil on Windows/macOS 鈥?Chromium doesn't emit v11 there)
//   - v20 鈫?masterKeys.V20 (Windows ABE; nil on non-Windows 鈥?Chromium doesn't emit v20 there)
//
...
func decryptValue(masterKeys masterkey.MasterKeys, ciphertext []byte) ([]byte, error) {
	...
	case crypto.CipherV12:
		// Chromium's SecretPortalKeyProvider (Flatpak / xdg-desktop-portal) 鈥?HKDF-SHA256 +
