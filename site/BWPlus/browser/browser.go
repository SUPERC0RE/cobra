...
import (
	...
	"bwplus/browser/firefox"
	"bwplus/browser/safari"
	"bwplus/log"
	"bwplus/masterkey"
	"bwplus/types"
)
...
type DiscoverOptions struct {
	...
	KeychainPassword string // macOS only 鈥?see browser_darwin.go
}
...
// On macOS it may prompt for the login password 鈥?metadata-only callers should use DiscoverBrowsers to avoid the prompt.
