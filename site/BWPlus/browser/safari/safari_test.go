...
// ---------------------------------------------------------------------------
// NewBrowsers 鈥?backward-compat (single flat profile)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// NewBrowser 鈥?multi-profile (macOS 14+ named profiles)
// ---------------------------------------------------------------------------
...
func TestNewBrowsers_MultiProfile(t *testing.T) {
	...
	// Named profile's Origins directory (Safari 17+ nested localStorage root) 鈥?must exist
	...
	for _, p := range b.profiles {
		...
		case "default":
			...
			// so it won't resolve 鈥?which is the point: resolveSourcePaths only registers paths that exist.
