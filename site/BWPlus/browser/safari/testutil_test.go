...
// ---------------------------------------------------------------------------
// Real Safari table schemas 鈥?extracted via `sqlite3 History.db ".schema"`.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// LocalStorage fixtures 鈥?modern WebKit nested Origins layout
// ---------------------------------------------------------------------------
...
// variant of buildTestLocalStorageDir 鈥?use it when the test targets one DB, not the full
// Origins nesting.
...
// encodeUTF16LE is the inverse of extract_storage.go's decodeUTF16LE 鈥?it mirrors
