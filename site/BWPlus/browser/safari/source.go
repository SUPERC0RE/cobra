...
// defaultSources: cookies try macOS 14+ container first, then the 鈮?3 legacy path.
// LocalStorage for the default profile lives under WebsiteData/Default 鈥?the pre-profile-era
...
// LocalStorage lives under WebKit/WebsiteDataStore/<uuidLower>/Origins 鈥?Safari 17+ uses a nested
