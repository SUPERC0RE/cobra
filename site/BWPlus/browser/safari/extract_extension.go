...
//
//	Safari/AppExtensions/Extensions.plist   鈥?legacy App Extensions (XPC-based)
//	Safari/WebExtensions/Extensions.plist   鈥?modern Safari Web Extensions
//
...
// (Permissions, AccessibleOrigins, 鈥? are intentionally ignored for the
