...
// Package winutil provides high-level Windows utilities for BWData,
...
//
// The C-side counterpart 鈥?CLSID / IID / vtable-slot bytes consumed by the
// reflective payload 鈥?lives in crypto/windows/abe_native/com_iid.c and
...
const (
	// ABENone means this browser has no ABE path 鈥?the key retriever chain
